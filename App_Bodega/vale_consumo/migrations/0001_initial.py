# Generated by Django 4.2 on 2023-08-28 16:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_centro_costo', models.CharField(max_length=200)),
                ('crr', models.IntegerField()),
                ('g_part', models.CharField(max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retira', models.CharField(max_length=200)),
                ...
                ('preparador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Preparador', to='vale_consumo.personal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_unidad', models.CharField(max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado_despacho', models.CharField(choices=[('Sin Stock', 'Sin Stock'), ('Realizado', 'Realizado')], default='Sin Stock', max_length=15)),
